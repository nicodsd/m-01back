...
let router = Router()
router.get("/", read)
router.post("/postfood/:user_id", formIdableFoods, passport.authenticate("jwt", { session: false }), nameAlreadyExistFood, cloudinaryUploadMiddleware, validator(foodSchema), createFoodByUserId);
