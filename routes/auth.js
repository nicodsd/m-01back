...
router.post("/signup", formIdable, nameAlreadyExist, emailAlreadyExist, createHash, cloudinaryUploadMiddlewareById, validator(userSignUp), signUp);
...
router.put("/update/:id", passport.authenticate("jwt", { session: false }), formIdable, nameAlreadyExist, cloudinaryUploadMiddlewareById, validator(userUpdate), updateUser);
