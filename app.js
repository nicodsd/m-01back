...
app.use(cors({
  origin: function (origin, callback) {
    ...
    if (!origin || origin.includes("trycloudflare.com") || origin.includes("https://qmenu.digital") || origin.includes("https://qrmenu-ouxsic4yh-nicodsds-projects.vercel.app") || origin.includes("http://localhost:3000")) {
      callback(null, true);
    } else {
